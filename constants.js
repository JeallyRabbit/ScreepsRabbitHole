...
const DEFAULT_COLONIZE_SOLDIERS_AMOUNT=2;
const RAMPARTS_REPAIRERS_FACTOR=1.5// higher value - more repairers
const MIN_BOOSTING_TTL=1000
const CARRIERS_LIMIT=30
...
const MAX_WORKERS_POPULATION=20
...
const LINEAR_WORKERS_AMOUNT_ENERGY_EDGE=STORAGE_ENERGY_BOTTOM//STORAGE_TOP_ENERGY-UPGRADE_FACTOR_1
const LINK_BOTTOM_ENERGY = LINK_CAPACITY * (2 / 8)
const LINK_TOP_ENERGY = LINK_CAPACITY * (7 / 8)
const LINK_FREE_SPACE=LINK_CAPACITY*(2/8)
const COLONIZE_ENERGY_LIMIT = 40000
const MIN_RAW_RESOURCE_AMOUNT = 10000 // minimum amount in terminal
const MAX_RAW_RESOURCE_AMOUNT = 30000 // maximum amount in terminal
const RESOURCE_SHARE_AMOUNT = 5000
const RAW_RES_BUY_AMOUNT = 10000; // how much buy in orders
...
const RAMPART_MIN_WORKER_HITS=RAMPART_DECAY_AMOUNT*100
const RAMPARTS_HITS_REPAIR_STOP=250000
const RAMPARTS_HITS_REPAIR_START=100000
...
module.exports = {
  ...
  DEFAULT_COLONIZE_SOLDIERS_AMOUNT,
  ...
  RAMPARTS_HITS_REPAIR_STOP,
  RAMPARTS_HITS_REPAIR_START,
